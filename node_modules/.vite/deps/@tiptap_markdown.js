import {
  ...
  generateJSON,
  getExtensionField
} from "./chunk-PIROTRDA.js";
import "./chunk-RB3W4PNI.js";
import "./chunk-AXDN6QSU.js";
import "./chunk-VNRHPACU.js";
import "./chunk-PKNNLRUD.js";
import "./chunk-GFRR3TLS.js";
...
var MarkdownManager = class {
  ...
  constructor(options2) {
    ...
    var _a, _b, _c, _d, _e;
    this.markedInstance = (_a = options2 == null ? void 0 : options2.marked) != null ? _a : marked;
    this.lexer = new this.markedInstance.Lexer();
    this.indentStyle = (_c = (_b = options2 == null ? void 0 : options2.indentation) == null ? void 0 : _b.style) != null ? _c : "space";
    this.indentSize = (_e = (_d = options2 == null ? void 0 : options2.indentation) == null ? void 0 : _d.size) != null ? _e : 2;
    this.baseExtensions = (options2 == null ? void 0 : options2.extensions) || [];
    if ((options2 == null ? void 0 : options2.markedOptions) && typeof this.markedInstance.setOptions === "function") {
      this.markedInstance.setOptions(options2.markedOptions);
    }
    this.registry = /* @__PURE__ */ new Map();
    this.nodeTypeRegistry = /* @__PURE__ */ new Map();
    if (options2 == null ? void 0 : options2.extensions) {
      this.baseExtensions = options2.extensions;
      const flattened = flattenExtensions(options2.extensions);
...
`);
  ...
  */
  ...
  parseHTMLToken(token) {
    const html2 = token.text || token.raw || "";
    if (!html2.trim()) {
      return null;
    }
    try {
...
var Markdown = Extension.create({
  ...
  addCommands() {
    return {
      setContent: (content, options2) => {
        if (!(options2 == null ? void 0 : options2.contentType)) {
          return commands_exports.setContent(content, options2);
        }
        const actualContentType = assumeContentType(content, options2 == null ? void 0 : options2.contentType);
        if (actualContentType !== "markdown" || !this.editor.markdown) {
          return commands_exports.setContent(content, options2);
        }
        const mdContent = this.editor.markdown.parse(content);
        return commands_exports.setContent(mdContent, options2);
      },
      insertContent: (value, options2) => {
        if (!(options2 == null ? void 0 : options2.contentType)) {
          return commands_exports.insertContent(value, options2);
        }
        const actualContentType = assumeContentType(value, options2 == null ? void 0 : options2.contentType);
        if (actualContentType !== "markdown" || !this.editor.markdown) {
          return commands_exports.insertContent(value, options2);
        }
        const mdContent = this.editor.markdown.parse(value);
        return commands_exports.insertContent(mdContent, options2);
      },
      insertContentAt: (position, value, options2) => {
        if (!(options2 == null ? void 0 : options2.contentType)) {
          return commands_exports.insertContentAt(position, value, options2);
        }
        const actualContentType = assumeContentType(value, options2 == null ? void 0 : options2.contentType);
        if (actualContentType !== "markdown" || !this.editor.markdown) {
          return commands_exports.insertContentAt(position, value, options2);
        ...
        const mdContent = this.editor.markdown.parse(value);
        return commands_exports.insertContentAt(position, mdContent, options2);
      }
    };
  },
  addStorage() {
