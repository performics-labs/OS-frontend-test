import {
  require_react_dom
} from "./chunk-YTXV6KTB.js";
import {
  require_jsx_runtime
} from "./chunk-BAN2ZYDC.js";
import {
  require_react
} from "./chunk-TOP7BFWB.js";
import {
  __toESM
...
var measuringCellClassname = "mlln6zg7-0-0-beta-58";
...
var cell = "cj343x07-0-0-beta-58";
var cellClassname = `rdg-cell ${cell}`;
var cellFrozen = "csofj7r7-0-0-beta-58";
var cellFrozenClassname = `rdg-cell-frozen ${cellFrozen}`;
var cellDragHandle = "ch2wcw87-0-0-beta-58";
var cellDragHandleFrozenClassname = "c1wvphzh7-0-0-beta-58";
...
var checkbox = "c1bn88vv7-0-0-beta-58";
...
var groupCellContent = "g1s9ylgp7-0-0-beta-58";
var groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
var caret = "cz54e4y7-0-0-beta-58";
...
var headerSortCellClassname = "h44jtk67-0-0-beta-58";
var headerSortName = "hcgkhxz7-0-0-beta-58";
...
var cellDraggedOver = "c6ra8a37-0-0-beta-58";
...
var cellEditing = "cis5rrm7-0-0-beta-58";
function EditCell({ column, colSpan, row: row$1, rowIdx, onRowChange, closeEditor, onKeyDown, navigate }) {
  ...
  const commitOnOutsideMouseDown = (0, import_react.useEffectEvent)(() => {
    onClose(true, false);
  });
  (0, import_react.useLayoutEffect)(() => {
...
var cellSortableClassname = "c6l2wv17-0-0-beta-58";
var cellResizable = "c1kqdw7y7-0-0-beta-58";
var cellResizableClassname = `rdg-cell-resizable ${cellResizable}`;
var resizeHandle = "r1y6ywlx7-0-0-beta-58";
var resizeHandleClassname = `rdg-resize-handle ${resizeHandle}`;
var cellDraggableClassname = "rdg-cell-draggable";
var cellDragging = "c1bezg5o7-0-0-beta-58";
var cellDraggingClassname = `rdg-cell-dragging ${cellDragging}`;
var cellOver = "c1vc96037-0-0-beta-58";
var cellOverClassname = `rdg-cell-drag-over ${cellOver}`;
var dragImageClassname = "d8rwc9w7-0-0-beta-58";
...
var arrow = "a3ejtar7-0-0-beta-58";
...
var root = "rnvodz57-0-0-beta-58";
var rootClassname = `rdg ${root}`;
var viewportDragging = "vlqv91k7-0-0-beta-58";
var viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;
var focusSinkClassname = "f1lsfrzw7-0-0-beta-58";
var focusSinkHeaderAndSummaryClassname = "f1cte0lg7-0-0-beta-58";
var summaryCellClassname = "s8wc6fl7-0-0-beta-58";
...
var summaryRow = "skuhp557-0-0-beta-58";
var topSummaryRow = "tf8l5ub7-0-0-beta-58";
...
var groupRow = "g1yxluv37-0-0-beta-58";
...
var textEditorInternalClassname = "t7vyx3i7-0-0-beta-58";
